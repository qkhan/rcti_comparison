...
if __name__ == '__main__':
    ...
    referrer_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/referrers"""
    referrer_infynity_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/{infynity_process_id}/referrers"""
    broker_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/brokers"""
    broker_infynity_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/{infynity_process_id}/brokers"""
    branch_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/branch"""
    branch_infynity_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/{infynity_process_id}/branch"""
    branch_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/branch"""
    es_infynity_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/{infynity_process_id}/executive_summary_report"""
    infynity_es_file = os.listdir(es_infynity_dir)[0]
    infynity_es_filepath = f"""{es_infynity_dir}/{infynity_es_file}"""
    es_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/executive_summary_report"""
    loankit_es_file = os.listdir(es_loankit_dir)[0]
    loankit_es_filepath = f"""{es_loankit_dir}/{loankit_es_file}"""
    aba_infynity_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/{infynity_process_id}/de_file"""
    infynity_aba_file = os.listdir(aba_infynity_dir)[0]
    infynity_aba_filepath = f"""{aba_infynity_dir}/{infynity_aba_file}"""
    aba_loankit_dir = f"""/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/{loankit_process_id}/de_file"""
    ...
    rcti_compare_executive_summary(
         loose,
         loankit_es_filepath,
         infynity_es_filepath)
    rcti_compare_aba(
    	loankit_aba_filepath,
    	infynity_aba_filepath)

    # rcti_compare_referrer(
    #rcti_compare_referrer(
         #1,
         #'/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/loankit/22369/referrers',
         #'/Users/qaisar/Desktop/rcti_comparison_scripts/commission-comparer-infynity/inputs/infynity/3096_Tue_Jul_07_2020/referrers')
    # rcti_compare_broker(
    #     1,
