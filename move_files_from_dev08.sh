...
echo -e "python ${BASEDIR}/scripts/move_infynity_files_to_test_dir.py ${infynity_process_id}\n"
python ${BASEDIR}/scripts/move_infynity_files_to_test_dir.py ${infynity_process_id}
echo -e "python ${BASEDIR}/scripts/move_loankit_files_to_test_dir.py ${loankit_process_id}\n"
python ${BASEDIR}/scripts/move_loankit_files_to_test_dir.py ${loankit_process_id}
echo -e "python ${BASEDIR}/cli.py ${loose} ${loankit_process_id} ${infynity_process_id}\n"
python ${BASEDIR}/cli.py ${loose} ${loankit_process_id} ${infynity_process_id}
